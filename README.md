...
BM25Search - это простой и эффективный поисковый движок, основанный на алгоритме BM25 с поддержкой стемминга и лемматизации для русского и английского языков. Пакет был упрощен до чистой реализации BM25 без синонимов и LLM-функций.
...
Удалены все дополнительные функции:
- ❌ Поддержка синонимов
- ❌ LLM интеграция
- ❌ Контекстное скоринг
- ✅ Только классический BM25
